...
<p class="titulo">Nome do paciente</p>
        <div class="dados-cliente">
            <i class="material-icons ">account_circle</i>
            <p class="descricao-cliente">IDADE: </p>
            <p class="descricao-cliente">SEXO: </p>
            <p class="descricao-cliente">RG: <span></span> </p>
            <p class="descricao-cliente">CPF: <span></span></p>
        </div>
        <div class="conjunto-botao">
            <a class="waves-effect waves-light btn-small btn-menu">INICIAR TRIAGEM</a>
        <a class="waves-effect waves-light btn-small btn-menu" href="">HISTÓRICO</a>
